...
import com.sreedwish.cybazeapp.databinding.FragBtn2Binding;
...
public class Frag2Digit extends Fragment implements View.OnClickListener{

    FragBtn2Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.frag_btn_2,container,false);
       ...
       btnSingle = binding.btnAndroid;
        ...
        vaf.textWatcherNumberCount(binding.edtNumber,binding.edtCount,context,2);
        vaf.textWatcherNumberCount(binding.edtCount,null,context,2);

        vaf.textWatcherNumberCount(binding.edtStart,binding.edtEnd,context,2);

        vaf.textWatcherNumberCount(binding.edtEnd, binding.edtStep , binding.edtCount2 , context,2);

        vaf.textWatcherNumberCount(binding.edtStep,binding.edtCount2,context,2);
        vaf.textWatcherNumberCount(binding.edtCount2,null,context,2);
