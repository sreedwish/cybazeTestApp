...
public class Frag1Digit extends Fragment implements View.OnClickListener {

    FragBtn1Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       binding = DataBindingUtil.inflate(inflater, R.layout.frag_btn_1,container,false);
       ...
       btnSingle.setOnClickListener(new View.OnClickListener() {
        ...
        vaf.textWatcherNumberCount(binding.edtNumber,binding.edtCount,context,1);
        vaf.textWatcherNumberCount(binding.edtCount,null,context,1);

        vaf.textWatcherNumberCount(binding.edtStart,binding.edtEnd,context,1);

        vaf.textWatcherNumberCount(binding.edtEnd, binding.edtStep , binding.edtCount2 , context,1);

        vaf.textWatcherNumberCount(binding.edtStep,binding.edtCount2,context,1);
        vaf.textWatcherNumberCount(binding.edtCount2,null,context,1);
